                    ...
                    <div class="total_area">
                        <ul>
                            @if(Session::has('discount_amount_price'))
                                <li>Sub Total <span>Rp {{$total_price}} K</span></li>
                                <li>Coupon Discount (Code : {{Session::get('coupon_code')}}) <span>Rp {{Session::get('discount_amount_price')}} K</span></li>
                                <li>Total <span>Rp {{$total_price-Session::get('discount_amount_price')}} K</span></li>
                            @else
                                <li>Total <span>Rp {{$total_price}} K</span></li>
                            @endif
                        </ul>

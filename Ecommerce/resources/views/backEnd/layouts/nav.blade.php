...
<div id="sidebar"><a href="{{url('/admin')}}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <li class="submenu {{$menu_active==5? ' active':''}}"> <a href="#"><i class="icon icon-th-list"></i> <span>User</span></a>
            <ul>
             <li><a href="{{route('user.Show')}}">List user</a></li> 
              <!--   <li><a href="{url('/admin/user/Show')}}">List user</a></li> -->
            </ul>
        </li>
    </ul>
</div>

    ...
    <div class="container">
        ...
        <div class="row">
            <form action="{{url('/submit-order')}}" method="post" class="form-horizontal">
                ...
                <input type="hidden" name="order_status" value="on progres">
                ...
                <div class="col-sm-12">
                    ...
                    <section id="cart_items">
                                        ...
                                        <table class="table table-condensed total-result">
                                            ...
                                            @if(Session::has('discount_amount_price'))
                                                <tr class="shipping-cost">
                                                    ...
                                                    <td>Rp {{Session::get('discount_amount_price')}} K</td>
                                                </tr>
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>Rp {{$total_price-Session::get('discount_amount_price')}} K</span></td>
                                                </tr>
                                            @else
                                                <tr>
                                                    <td>Total</td>
                        ...
                        <span>
                            <label><input type="radio" name="payment_method" value="COD" checked> Cash On Delivery Only in Yogyakarta</label>
                        </span>
                            <span>

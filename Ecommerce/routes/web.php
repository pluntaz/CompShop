...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function (){
    ...
    Route::get('finish-oreder/{id}','AdminController@FinishOrder');
    Route::get('detailorder/{id}','AdminController@detailorder')->name('detailorder');
  ...
  //  Route::resource('/','OrdersController');
    ...
    Route::get('/user/Show','UsersController@UsersShow')->name('user.Show');;
